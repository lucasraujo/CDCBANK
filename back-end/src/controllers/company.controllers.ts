...
const getAllCompanyController = async (request:Request, response:Response) : Promise<Response> => {
...
const getOneCompanyController = async (request:Request, response:Response) : Promise<Response> => {
...
export {createCompanyController, getAllCompanyController, getOneCompanyController }