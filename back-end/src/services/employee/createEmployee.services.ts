...
import { IEmployee, IEmployeeCreate } from "../../interfaces/employee.interfaces";
import Company from "../../entities/company.entity";
import { AppError } from "../../errors";


const createEmployeeServices = async (companyId:string, employeeData: IEmployeeCreate ): Promise<IEmployee> =>{
    ...
    const companyCpf: Employee|null = await employeeRepository.findOne({
        where:{
    ...
    const newUser = employeeRepository.create({...employeeData, company: company})
