...
import { iCompany, iLoginProvider, iLoginTypes } from "./types";
...
const getAllCompanies = async () => {
    ...
    return (
    <LoginContext.Provider value={{getAllCompanies, allCompanies, setAllCompanies, selectValue ,setSelectValue, handleButton}}>	 
            {children}	
